...
<body>
  <nav class="navbar navbar-dark bg-dark mynav">
    <div class="container">
      ...
      <a  class="navbar-brand mynav-link mycate"  href="" > الطعام| FOOD </a>
      <div class="dropdown">
  ...
  <div class="imagebackground" style=" overflow: hidden; height: 92vh; ">
    <img src="../admin/image/food1.svg" class="image" alt="food">
  </div>
  <?php 
  require_once 'config.php';
  $sql = "SELECT * FROM products WHERE `category`='FOOD' or `category`='food' or `category`='Food'";
