...
<head>
  ...
  <title>Electronics | الإلكترونيات</title>
...
<body>
  <nav class="navbar navbar-dark bg-dark mynav">
    <div class="container">
      ...
      <a  class="navbar-brand mynav-link mycate"  href="" > الإلكترونيات| Electronics </a>
      <div class="dropdown">
  ...
  <div class="imagebackground" style=" overflow: hidden; height: 92vh; ">
    <img src="../admin/image/2119464.jpg" class="image" alt="Electronics" style=" width: 100%; height: 109vh; ">
  </div>
  <?php 
  require_once 'config.php';
  $sql = "SELECT * FROM products WHERE `category`='Electronics' Or `category`='electronics'";
